  ...
  Chat.MockData = (function(_super) {
    ...
    function MockData() {
      ...
      this.cleanUp = function() {
        return MockData.prototype.cleanUp.apply(_this, arguments);
      };
      this.kill = function(items) {
        return MockData.prototype.kill.apply(_this, arguments);
      };
      this.completeTasksByTitle = function(title) {
        return MockData.prototype.completeTasksByTitle.apply(_this, arguments);
      };
      this.completeTasksByOwner = function(owner) {
        return MockData.prototype.completeTasksByOwner.apply(_this, arguments);
      };
      this.generate = function() {
        return MockData.prototype.generate.apply(_this, arguments);
      };
      this.randomInt = function(min, max) {
        return MockData.prototype.randomInt.apply(_this, arguments);
      };
      this.createUsers = function() {
        return MockData.prototype.createUsers.apply(_this, arguments);
      };
      this.createMessages = function(num) {
        if (num == null) {
          num = 1;
        }
        return MockData.prototype.createMessages.apply(_this, arguments);
      };
      this.createTasks = function(num) {
        if (num == null) {
          num = 1;
        }
        return MockData.prototype.createTasks.apply(_this, arguments);
      };
      this.socket = Batman.Socket.getInstance();
      this.massenger = this.socket.socket;
    }
